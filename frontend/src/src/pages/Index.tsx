...
const ratings = [
  {
    id: "1",
    name: "Priya Kumari",
    comment: "Sakchi mein aisa salon pehli baar mila. Hair styling toh ekdum party ready bana diya. Didi log bahut hi sweet hain!",
    rating: 5,
  ...
  },
  {
    id: "2",
    name: "Neha Soren",
    comment: "Sonari se aayi thi facial ke liye, skin ekdum glow kar gaya. Clean jagah hai aur madam log ache se samjhate hain. Super service!",
    rating: 5,
  ...
  },
  {
    id: "3",
    name: "Ritika Singh",
    comment: "Threading aur waxing bohot hi smooth tha. Pain bhi kam laga. Baridih se aayi thi, full paisa vasool!",
    rating: 4.8,
    type: "website" as const,
    date: "2024-01-18",
    order: 3
  },
  {
    id: "4",
    name: "Anjali Das",
    comment: "Bridal makeup package liya tha. Look ekdum royal tha shaadi mein! Kadma ke salon se toh kaafi better hai yeh.",
    rating: 5,
    type: "google" as const,
    date: "2024-01-22",
    location: "Kadma",
